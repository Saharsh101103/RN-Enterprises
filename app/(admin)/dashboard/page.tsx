...
const messages = [
    {
      id: 1,
      customerName: "Olivia",
      email: "oliviasingh@nawabmotors.com",
      date: "January 52, 1000BC",
      status: "Read",
      message: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis officiis cum commodi neque. Consequatur eos voluptas nihil officia quae numquam, sed, unde dignissimos, explicabo nisi vero vitae. Vero, saepe iste." 
    },
    {
      id: 1,
      customerName: "Olivia",
  ...
  useEffect(() => {
    const fetchMessages = async () => {
      try {
        ...
        setMessages(response.data.data || []);  // Fallback to an empty array if no messages
        setLoading(false);
      } catch (error) {
